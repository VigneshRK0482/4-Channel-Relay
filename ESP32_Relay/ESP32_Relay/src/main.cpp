...
// Defining the pins for channels of 4 relay module. The numbers are the GPIO pin numbers of ESP32
...
void setup() 
{
  ...
  digitalWrite(RELAY_PIN_4, LOW);   
  Serial.begin(115200); // Initialising Serial Monitor with 115200 Baud Rate
